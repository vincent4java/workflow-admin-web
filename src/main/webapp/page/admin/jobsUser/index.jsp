            ...
            <div class="col-xs-12">
              <div class="box">
					...
					<nav class="navbar navbar-default" role="navigation">
					   <div>
					      <ul class="nav navbar-nav">
					         <li class="active"><a href="view" name="tab">查看岗位与人员与人员</a></li>
					         <li><a href="add" name="tab">新增岗位与人员与人员</a></li>
					      </ul>
					   </div>
					</nav>
                </div><!-- /.box-header -->
				...
				<div class="tab-content"> 
					...
					<table id="data-table" data-url="/jobsUser/findJobsUserVOJson.do" data-height="555" data-method="post" data-show-refresh="true" 
